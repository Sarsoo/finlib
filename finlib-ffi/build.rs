...
fn main() {
    ...
    csbindgen::Builder::default()
        ...
        .input_extern_file("src/portfolio_asset.rs")
        .input_extern_file("src/indicators.rs")
        .input_extern_file("src/price.rs")
        .input_extern_file("src/price_pair.rs")
        .input_extern_file("src/price_range.rs")
        .input_extern_file("src/price_range_pair.rs")
        .input_extern_file("src/price_timestamp.rs")
        ...
        .input_extern_file("../finlib/src/market_data/mod.rs")
        .input_extern_file("../finlib/src/market_data/price_range.rs")
        ...
        .input_extern_file("../finlib/src/price/price_pair.rs")
